...
<body>
    <div class="main"><img src="./700.jpg" alt="Compact" width="700px" height="400px">
    <form action="orderconf4.php" method="post">
		<h3>Order car</h3>
		<p>color: <input name="color" type="text" placeholder="red, black,lightblue"></p>
